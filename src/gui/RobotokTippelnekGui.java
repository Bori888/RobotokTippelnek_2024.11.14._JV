...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtVelSzam2, txtVelszam1});
    ...
    private void Kilepes() throws HeadlessException {
        ...
        int viszateresiErtek = JOptionPane.showConfirmDialog(rootPane, uzenet, cim, gombok);
        System.out.println(viszateresiErtek);
        if (viszateresiErtek == JOptionPane.OK_OPTION) {
    ...
    private void btnGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneralActionPerformed
        int minErtek =  (int) numMin.getValue();
        int maxErtek =  (int) numMax.getValue();
        System.out.println("A minimum aktuális értéke:"+minErtek);
        System.out.println("A maximum aktuális értéke:"+maxErtek);
        int veletlenszam;
//        Random rnd = new Random();
//        veletlenszam = rnd.nextInt((int)minErtek, (int)maxErtek);
        int db = maxErtek- minErtek + 1; 
        veletlenszam = (int)(Math.random()*db)+ minErtek;
        System.out.println(veletlenszam);
        txtVelszam1.setText(veletlenszam +" ");
        txtVelSzam2.setText(veletlenszam +" ");
